          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-dark-800 border border-slate-700 rounded-xl pl-10 pr-4 py-2.5 text-white placeholder-slate-500 focus:outline-none focus:border-primary-500 transition"
              />
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                {filtered.map((topic) => (
                  <button
                    ...
                    className={`w-full flex items-start gap-2 px-2.5 py-2 rounded-xl border text-left transition text-sm font-medium
                      ${
                        selected === topic.name
                  ...
                  >
                    <span className="text-sm leading-5 mt-0.5">
                      {topic.icon}
                    </span>
          ...
          <div className="space-y-4">
            <div className="bg-dark-800 rounded-2xl border border-slate-700 p-5">
              ...
              <div className="mb-4">
                ...
                <div className="bg-dark-900 rounded-lg px-3 py-3 text-white min-h-[72px] border border-slate-800">
                  {finalTopic ? (
                    <>
                      <div className="text-sm font-medium leading-5">
                        {finalTopic}
                      </div>
                      <div className="text-xs text-slate-300 mt-2 leading-5 break-words whitespace-pre-wrap">
